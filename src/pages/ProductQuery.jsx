...
import ProductQueryTable from "@/components/productquerytable/ProductQueryTable";
...
const ProductQuery = () => {
  ...
  useEffect(() => {
    const fetchQueries = async () => {
      ...
      setError("");
      try {
        const res = await AdminServices.getProductQuery(
          currentPage,
          resultsPerPage
        );
        setResult(res)
      ...
      {loading ? (
        ...
        <TableContainer className="mb-8 rounded-b-lg">
          <Table>
            ...
            <ProductQueryTable staffs={queries} lang={lang} />
          </Table>
          <TableFooter>
